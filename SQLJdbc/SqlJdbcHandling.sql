DROP TABLE db_laptrinhjava.authorlSBN;
DROP TABLE db_laptrinhjava.titles;
DROP TABLE db_laptrinhjava.authors;

CREATE TABLE db_laptrinhjava.authors (
...
CREATE TABLE db_laptrinhjava.titles (
...
CREATE TABLE db_laptrinhjava.authorISBN (
authorID INT NOT NULL,
isbn varchar (20) NOT NULL,
FOREIGN KEY (authorID) REFERENCES db_laptrinhjava.authors (authorID),
FOREIGN KEY (isbn) REFERENCES db_laptrinhjava.titles (isbn)
);

INSERT INTO db_laptrinhjava.authors (firstName, lastName)
VALUES
('Paul','Deitel'),
('Harvey','Deitel'),
('Abbey','Deitel'),
...
INSERT INTO db_laptrinhjava.titles (isbn,title,editionNumber,copyright)
VALUES
...
INSERT INTO db_laptrinhjava.authorISBN (authorID,isbn)
VALUES
(1,'0132151006'),
(2,'0132151006'),
(3,'0132151006'),
